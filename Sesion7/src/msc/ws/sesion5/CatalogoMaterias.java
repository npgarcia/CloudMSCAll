...
public class CatalogoMaterias implements CatalogoMateriasInterface {
	 ...
	 */
	@Override
	public List<String> obtenerMateriasPorCategoria(String categoria){
	...
	@Override
	public List<Materia> obtenerListaMateriasPorCategoria(String categoria) throws EntradaInvalida{
		return materiasService.obtenerListaMaterias(categoria);
	}
